...
import net.medievalrp.omniscience.api.display.*;
import net.medievalrp.omniscience.api.entry.*;
import net.medievalrp.omniscience.api.flag.*;
import net.medievalrp.omniscience.api.interfaces.IOmniscience;
import net.medievalrp.omniscience.api.interfaces.WorldEditHandler;
import net.medievalrp.omniscience.api.parameter.*;
import net.medievalrp.omniscience.api.util.PastTenseWithEnabled;
import net.medievalrp.omniscience.command.OmniscienceCommand;
import net.medievalrp.omniscience.command.OmniscienceTabCompleter;
import net.medievalrp.omniscience.command.util.OmniTeleCommand;
import net.medievalrp.omniscience.io.StorageHandler;
import net.medievalrp.omniscience.listener.CraftBookSignListener;
import net.medievalrp.omniscience.listener.PluginInteractionListener;
import net.medievalrp.omniscience.listener.WandInteractListener;
...
final class OmniCore implements IOmniscience {
    ...
    private void registerParameters() {
        ...
        registerParameterHandler(new ServerParameter());
    }
    ...
    void onWorldEditStatusChange(boolean status) {
        if (status && OmniConfig.INSTANCE.doWorldEditInteraction()) {
            ...
            net.medievalrp.omniscience.worldedit.WorldEditLogger.register();
        } else {
            flagHandlerList.removeIf(fh -> fh instanceof FlagWorldEditSel);
            net.medievalrp.omniscience.worldedit.WorldEditLogger.unregister();
        }
    }
