...
import net.medievalrp.omniscience.api.entry.ActionResult;
import net.medievalrp.omniscience.api.entry.Actionable;
import net.medievalrp.omniscience.api.entry.ActionableException;
...
import net.medievalrp.omniscience.command.result.CommandResult;
import net.medievalrp.omniscience.command.result.UseResult;
import net.medievalrp.omniscience.command.util.SearchParameterHelper;
import net.medievalrp.omniscience.worldedit.FAWERollbackHandler;
