...
import net.medievalrp.omniscience.api.parameter.ParameterException;
import net.medievalrp.omniscience.api.query.QuerySession;
import net.medievalrp.omniscience.command.async.SearchCallback;
import net.medievalrp.omniscience.command.result.CommandResult;
import net.medievalrp.omniscience.command.result.UseResult;
import net.medievalrp.omniscience.command.util.Async;
