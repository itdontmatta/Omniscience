package net.medievalrp.omniscience.command.async;

import net.medievalrp.omniscience.Omniscience;
import net.medievalrp.omniscience.api.data.DataKeys;
import net.medievalrp.omniscience.api.display.DisplayHandler;
import net.medievalrp.omniscience.api.entry.DataAggregateEntry;
import net.medievalrp.omniscience.api.entry.DataEntry;
import net.medievalrp.omniscience.api.entry.DataEntryComplete;
...
import net.medievalrp.omniscience.command.commands.PageCommand;
